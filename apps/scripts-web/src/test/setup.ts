 ...
 * (used by @packages/shared-lib) dispatches browser-standard `MessageEvent` instances
...
if (!isIntegrationTest) {
  vi.mock('@packages/shared-lib/client', async () => {
    const actual = await vi.importActual('@packages/shared-lib/client') as Record<string, unknown>
    return {
      ...actual,
